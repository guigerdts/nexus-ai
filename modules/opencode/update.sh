#!/usr/bin/env bash
# modules/opencode/update.sh
# Actualiza opencode a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-opencode}..."

_pkg="${AGENT_PACKAGE:-opencode}"
