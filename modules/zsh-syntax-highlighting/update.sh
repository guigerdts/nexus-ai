#!/usr/bin/env bash
# modules/zsh-syntax-highlighting/update.sh
# Actualiza zsh-syntax-highlighting a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-zsh-syntax-highlighting}..."
