#!/usr/bin/env bash
# modules/postgresql/update.sh
# Actualiza postgresql a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-postgresql}..."

_pkg="${AGENT_PACKAGE:-postgresql}"
