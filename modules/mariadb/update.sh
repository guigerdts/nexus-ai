#!/usr/bin/env bash
# modules/mariadb/update.sh
# Actualiza mariadb a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-mariadb}..."

_pkg="${AGENT_PACKAGE:-mariadb}"
