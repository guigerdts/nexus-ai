#!/usr/bin/env bash
# modules/nodemon/update.sh
# Actualiza nodemon a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-nodemon}..."

_pkg="${AGENT_PACKAGE:-nodemon}"
