#!/usr/bin/env bash
# modules/zsh-completions/update.sh
# Actualiza zsh-completions a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-zsh-completions}..."
