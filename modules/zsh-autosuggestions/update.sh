#!/usr/bin/env bash
# modules/zsh-autosuggestions/update.sh
# Actualiza zsh-autosuggestions a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-zsh-autosuggestions}..."
