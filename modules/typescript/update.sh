#!/usr/bin/env bash
# modules/typescript/update.sh
# Actualiza typescript a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-typescript}..."

_pkg="${AGENT_PACKAGE:-typescript}"
