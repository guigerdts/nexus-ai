#!/usr/bin/env bash
# modules/lazygit/update.sh
# Actualiza lazygit a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-lazygit}..."

_pkg="${AGENT_PACKAGE:-lazygit}"
