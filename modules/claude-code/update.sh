#!/usr/bin/env bash
# modules/claude-code/update.sh
# Actualiza claude-code a la version mas reciente
...
log_info "Verificando actualizacion para ${AGENT_NAME:-claude-code}..."

_pkg="${AGENT_PACKAGE:-claude-code}"
